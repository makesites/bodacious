...
// Events
//util.inherits(Main, events.EventEmitter); // not working?
...
Main.prototype = {
	...
	run: function(){
		...
		while(i--) {
			promises.push(this.queue.loadAsync().then(this.queue.processAsync.bind(this)))
		}
	...
	on: function( event, callback ){
		// TBA
		// event arent working in this version
		// save callbacks based on event
		return this;
	}
