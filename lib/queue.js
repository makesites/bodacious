...
var Queue = function Queue(name, options){
	...
	options.redis = _.assign({}, defaults.redis, options.redis );
	options = _.assign({}, defaults.options, options); // deep extend instead?
